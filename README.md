...
<br>
<br> e. **.github/workflows/main.yml**: GitHUb actions for **<em>installing required packaged</em>**, **<em>linting</em>**, **<em>testing</em>**, and **<em>formatting</em>** all the **.py** and **.ipynb** files, the executed commands of each action is specified in **MAKEFILE**.
